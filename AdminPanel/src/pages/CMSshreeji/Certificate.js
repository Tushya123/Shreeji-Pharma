...
import {
  ...
  removeCertificate,
  updateCertificate,
} from "../../functions/CMSshreeji/Certificate";
...
const Certificate = () => {
  ...
  const PhotoUpload = (e) => {
    if (e.target.files.length > 0) {
      ...
      setValues({ ...values, CertificateImage: e.target.files[0] });
        ...
        <form>
          <ModalBody>
            ...
            <Col lg={6}>
              ...
              />
              {isSubmit && (
                <p className="text-danger">{formErrors.CertificateImage}</p>
              )}
              {checkImagePhoto ? (
                <img
                  //   src={image ?? myImage}
        ...
        <form>
          <ModalBody>
            ...
            <Col lg={6}>
              ...
              {values.CertificateImage || photoAdd ? (
                <img
                  // key={photoAdd}
                  className="m-2"
                  src={
                    checkImagePhoto
                      ? photoAdd
                      : `${process.env.REACT_APP_API_URL_SHREEJI_PHARMACY}/${values.CertificateImage}`
                  }
                  width="300"
                  height="200"
                />
