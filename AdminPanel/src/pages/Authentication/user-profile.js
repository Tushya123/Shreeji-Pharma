...
const UserProfile = () => {
  ...
  document.title = "Profile | Contact_Owner";
  return (
    <React.Fragment>
        ...
        <Container fluid>
          <Row>
            <Col lg="12">
              ...
              {success ? <Alert color="success">Username Updated To {localStorage.getItem("AdminName")}</Alert> : null}
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1 align-self-center">
                      <div className="text-muted">
                        <h5>{localStorage.getItem("AdminName") || "Admin"}</h5>
                        <p className="mb-1">Email Id : {localStorage.getItem("Email")}</p>
