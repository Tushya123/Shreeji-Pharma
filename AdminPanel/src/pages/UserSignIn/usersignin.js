...
const UserSignIn = () => {
  ...
  const { firstName, lastName, email, password, mobile_no } =
    values;
...
if (values.mobile_no === ""||values.mobile_no.length<10) {
      errors.firstName = "Mobile Number should be of 10 digits!!";
      setErrMN(true);
    }
    if (values.mobile_no !== "") {
        setErrMN(false);
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">User Details</h2>
                    </Col>
