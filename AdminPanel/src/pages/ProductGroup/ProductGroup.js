        ...
        <form>
          <ModalBody>
            ...
            <div className="form-floating mb-3">
              ...
              {isSubmit && (
                <p className="text-danger">{formErrors.metaTitle}</p>
              )}
            </div>
            ...
            <div className="form-floating mb-3">
              ...
              {isSubmit && (
                <p className="text-danger">{formErrors.metaDescription}</p>
              )}
            </div>
            ...
            <div className="form-floating mb-3">
              ...
              {isSubmit && (
                <p className="text-danger">{formErrors.metaKeywords}</p>
              )}
            </div>
            <div className="form-floating mb-3">
              <Input
              ...
              {isSubmit && <p className="text-danger">{formErrors.metaURL}</p>}
            </div>
            ...
            <div className="form-floating mb-3">
              ...
              {isSubmit && (
                <p className="text-danger">{formErrors.metaImage}</p>
              )}
            </div>
            {/* <div className="form-floating mb-3">
              <Input
            ...
            <Col lg={6}>
              ...
              />
              {isSubmit && <p className="text-danger">{formErrors.ImageUrl}</p>}
              {checkImagePhoto ? (
                <img
                  //   src={image ?? myImage}
                  className="m-2"
