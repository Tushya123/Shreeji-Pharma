...
import {
    ...
    updateFeature,
    getFeature,
} from "../../functions/Feature/Featurefunc"
const initialState = {
    title: "",
    description: "",
  //email: "",
...
const Feature = () => {
  ...
  const { title, description, bannerImage, IsActive } =
    values;
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Feature</h2>
                    </Col>
